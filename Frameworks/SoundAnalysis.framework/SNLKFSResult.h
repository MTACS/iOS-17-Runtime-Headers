...
@interface SNLKFSResult : NSObject <NSCopying, NSSecureCoding, SNResult, SNTimeRangeProviding, SNTimeRangeProvidingWritable> {
    float  _decibelLevel;
    struct { 
        struct { 
            long long value; 
...
@property (nonatomic, readonly) float decibelLevel;
