...
@interface SNSpeechUtteranceResult : NSObject <NSCopying, NSSecureCoding, SNConfidenceProviding, SNConfidenceProvidingWritable, SNResult, SNTimeRangeProviding, SNTimeRangeProvidingWritable> {
    double  _confidence;
    bool  _detected;
    struct { 
        struct { 
