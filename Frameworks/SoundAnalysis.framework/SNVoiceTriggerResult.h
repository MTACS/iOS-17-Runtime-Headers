...
@interface SNVoiceTriggerResult : NSObject <SNConfidenceProviding, SNConfidenceProvidingWritable, SNResult, SNTimeRangeProviding, SNTimeRangeProvidingWritable> {
    double  _confidence;
    NSString * _name;
    struct { 
        struct { 
