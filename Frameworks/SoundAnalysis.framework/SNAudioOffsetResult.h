...
@interface SNAudioOffsetResult : NSObject <NSCopying, NSSecureCoding, SNConfidenceProviding, SNConfidenceProvidingWritable, SNResult, SNTimeRangeProviding, SNTimeRangeProvidingWritable> {
    double  _confidence;
    double  _offset;
    struct { 
        struct { 
