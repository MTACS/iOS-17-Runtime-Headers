...
- (id)initWithFaceIDModel:(struct shared_ptr<vision::mod::FaceID3Model> { struct FaceID3Model {} *x1; struct __shared_weak_count {} *x2; })arg1 faceprintRequestRevision:(unsigned long long)arg2 personUniqueIdentifierToSerialNumberMapping:(id)arg3;
