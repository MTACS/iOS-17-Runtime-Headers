...
@interface SCNNode : NSObject <NSCopying, NSSecureCoding, OZSCNNodeJSExport, SCNActionable, SCNAnimatable, SCNBoundingVolume, SCNTransactionCommandObject, UIFocusItem> {
