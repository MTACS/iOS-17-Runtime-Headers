...
@interface VCPFaceShapeModel : NSObject {
    ...
    int  _chCount;
    bool * _chPtSelected;
    struct { float x1; float x2; int x3; } * _chPts;
    float * _cur2D;
...
- (struct matrix<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout> { struct layout<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, 1> { double x_1_1_1[6]; } x1; })getPoseParam;
