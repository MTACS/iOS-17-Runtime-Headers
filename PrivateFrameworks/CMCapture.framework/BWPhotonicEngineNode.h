...
@interface BWPhotonicEngineNode : BWNode <BWAdaptiveBracketingController, BWDeepFusionProcessorControllerDelegate, BWDeferredCaptureControllerDelegate, BWDeferredProcessorControllerDelegate, BWInferenceEngineControllerDelegate, BWJasperColorStillsExecutorControllerDelegate, BWJasperDisparityProcessorControllerDelegate, BWLearnedNRProcessorControllerDelegate, BWNRFProcessorControllerDelegate, BWRedEyeReductionControllerDelegate, BWSWFRProcessorControllerDelegate, BWSoftISPProcessorControllerDelegate, BWStereoDisparityProcessorControllerDelegate, BWStillImageProcessingSupportProvider> {
