...
@property (nonatomic) <PKPaymentWebServiceTargetDeviceProtocol> *targetDevice;
...
- (void)addBiometricPassPreflightWithCompletion:(id /* block */)arg1;
...
- (id)initWithWebService:(id)arg1 targetDevice:(id)arg2 companionAgentConnection:(id)arg3;
- (bool)isPreflighting;
...
- (void)setNeedsSetAuthRandom:(bool)arg1;
