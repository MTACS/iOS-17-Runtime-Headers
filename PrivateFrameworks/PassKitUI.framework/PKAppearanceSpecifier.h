...
@interface PKAppearanceSpecifier : NSObject <NSCopying> {
    ...
    UIColor * _continueButtonTintColor;
...
@property (nonatomic, copy) UIColor *continueButtonTintColor;
...
- (void)setContinueButtonTintColor:(id)arg1;
