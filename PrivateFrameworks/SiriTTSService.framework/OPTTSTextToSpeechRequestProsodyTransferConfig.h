...
@property (nonatomic, readonly) OPTTSTextToSpeechUserVoiceProfile *user_voice_profile;
@property (nonatomic, readonly) NSString *user_voice_profile_url;
@property (nonatomic, readonly) OPTTSTextToSpeechSpeechFeatureInputWave *wave_data;
