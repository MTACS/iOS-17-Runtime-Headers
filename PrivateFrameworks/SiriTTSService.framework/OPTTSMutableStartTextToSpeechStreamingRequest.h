...
@property (nonatomic, copy) OPTTSTextToSpeechRequestDebug *debug;
@property (nonatomic, copy) OPTTSTextToSpeechRequestDevConfig *dev_config;
...
@property (nonatomic, copy) OPTTSTextToSpeechUserProfile *profile;
@property (nonatomic, copy) OPTTSTextToSpeechRequestProsodyTransferConfig *prosody_config;
@property (nonatomic, copy) OPTTSTextToSpeechRequestProsodyControlConfig *prosody_control_config;
