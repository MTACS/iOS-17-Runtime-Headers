...
@property (nonatomic, retain) NSDate *syncRequestedDate;
@property (nonatomic) unsigned long long type;
@property (nonatomic, retain) NSURL *url;

+ (unsigned long long)defaultFilterTypes;
+ (id)generateLegacyMailboxIdWithAccountId:(id)arg1 mailboxName:(id)arg2;
...
- (void)setSyncRequestedDate:(id)arg1;
