...
+ (id)stringForCoarseGeohash:(long long)arg1;
+ (id)stringForCoarseTimePOWLocation:(id)arg1 timeZone:(id)arg2 coarseGeohash:(long long)arg3;
+ (id)stringForDayOfWeek:(id)arg1 timeZone:(id)arg2;
+ (id)stringForSpecificGeohash:(long long)arg1;
+ (id)stringForSpecificTimeDOWLocation:(id)arg1 timeZone:(id)arg2 geohash:(long long)arg3;
+ (id)stringForTimeOfDayAndDayOfWeek:(id)arg1 timeZone:(id)arg2;
+ (id)stringForTwoHourTimeWindow:(id)arg1 timeZone:(id)arg2;
+ (id)stringForZoom7Geohash:(long long)arg1;
