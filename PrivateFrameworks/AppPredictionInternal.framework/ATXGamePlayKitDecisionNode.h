...
@interface ATXGamePlayKitDecisionNode : NSObject {
    struct shared_ptr<ATXGamePlayKitCDecisionNode> { 
        struct ATXGamePlayKitCDecisionNode {} *__ptr_; 
...
- (id)initWithNode:(struct shared_ptr<ATXGamePlayKitCDecisionNode> { struct ATXGamePlayKitCDecisionNode {} *x1; struct __shared_weak_count {} *x2; })arg1 tree:(id)arg2;
