...
+ (id)_formattedStringForNormalizedNumber:(id)arg1 showCreditCardNumber:(bool)arg2 showLastFourDigits:(bool)arg3 isVirtualCard:(bool)arg4;
+ (id)formattedStringForNormalizedNumber:(id)arg1 showCreditCardNumber:(bool)arg2;
