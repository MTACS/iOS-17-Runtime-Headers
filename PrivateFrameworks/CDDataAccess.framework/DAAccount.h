...
@property (nonatomic, readonly) NSString *hostWithoutPath;
...
- (void).cxx_destruct;
- (void)_dequeueQuery;
- (void)_handleSignificantPropertyChanges:(id)arg1;
...
- (void)removeDBSyncDataForAccountChange:(id)arg1;
...
- (bool)saveAccountPropertiesWithError:(id*)arg1;
