...
+ (id)domainWithName:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
...
- (id)_initWithName:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
...
- (id)initForTestingWithName:(id)arg1 plist:(id)arg2;
- (id)initNonContainerizedDomainWithName:(id)arg1 plist:(id)arg2 accountType:(long long)arg3 userVolumeMountPoint:(id)arg4;
- (bool)isAppDomain;
