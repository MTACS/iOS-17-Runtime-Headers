...
- (void)startDirectActionRequestWithAssistantId:(id)arg1 requestId:(id)arg2 inputOrigin:(id)arg3 utterance:(id)arg4 directAction:(id)arg5 requestExecutionParameters:(id)arg6 audioSource:(id)arg7 audioDestination:(id)arg8 responseMode:(id)arg9 isEyesFree:(bool)arg10 isVoiceTriggerEnabled:(bool)arg11 isTextToSpeechEnabled:(bool)arg12 isTriggerlessFollowup:(bool)arg13 bargeInModes:(id)arg14 approximatePreviousTTSInterval:(id)arg15 deviceRestrictions:(id)arg16 voiceTriggerEventInfo:(id)arg17 voiceAudioSessionId:(unsigned int)arg18 isSystemApertureEnabled:(bool)arg19;
- (void)startDirectActionRequestWithAssistantId:(id)arg1 requestId:(id)arg2 inputOrigin:(id)arg3 utterance:(id)arg4 directAction:(id)arg5 requestExecutionParameters:(id)arg6 audioSource:(id)arg7 audioDestination:(id)arg8 responseMode:(id)arg9 isEyesFree:(bool)arg10 isVoiceTriggerEnabled:(bool)arg11 isTextToSpeechEnabled:(bool)arg12 isTriggerlessFollowup:(bool)arg13 bargeInModes:(id)arg14 approximatePreviousTTSInterval:(id)arg15 deviceRestrictions:(id)arg16 voiceTriggerEventInfo:(id)arg17 voiceAudioSessionId:(unsigned int)arg18 isSystemApertureEnabled:(bool)arg19 isInAmbient:(bool)arg20;
