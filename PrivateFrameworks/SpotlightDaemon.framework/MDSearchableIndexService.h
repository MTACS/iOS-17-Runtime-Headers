...
- (void)_processIndexDataForBundle:(id)arg1 protectionClass:(id)arg2 personaID:(id)arg3 options:(long long)arg4 items:(id)arg5 itemsText:(id)arg6 clientState:(id)arg7 expectedClientState:(id)arg8 clientStateName:(id)arg9 deletes:(id)arg10 completionHandler:(id /* block */)arg11;
...
- (void)fetchAttributes:(id)arg1 protectionClass:(id)arg2 bundleID:(id)arg3 identifiers:(id)arg4 includeParents:(bool)arg5 qos:(unsigned int)arg6 reply:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (void)indexFromBundle:(id)arg1 protectionClass:(id)arg2 options:(long long)arg3 items:(id)arg4 itemsText:(id)arg5 itemsHTML:(id)arg6 clientState:(id)arg7 expectedClientState:(id)arg8 clientStateName:(id)arg9 deletes:(id)arg10 completionHandler:(id /* block */)arg11;
