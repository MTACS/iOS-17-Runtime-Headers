...
@interface VTAudioCircularBuffer : NSObject {
    ...
    struct unique_ptr<voicetrigger::VTAudioCircularBufferImpl<unsigned short>, std::default_delete<voicetrigger::VTAudioCircularBufferImpl<unsigned short>>> { 
        struct __compressed_pair<voicetrigger::VTAudioCircularBufferImpl<unsigned short> *, std::default_delete<voicetrigger::VTAudioCircularBufferImpl<unsigned short>>> { 
            void *__value_; 
        } __ptr_; 
