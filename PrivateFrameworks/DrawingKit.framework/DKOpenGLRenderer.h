...
@interface DKOpenGLRenderer : NSObject {
    ...
    struct vector<std::pair<float __attribute__((ext_vector_type(2))), float __attribute__((ext_vector_type(2)))>, std::allocator<std::pair<float __attribute__((ext_vector_type(2))), float __attribute__((ext_vector_type(2)))>>>="__begin_"^v"__end_"^v"__end_cap_"{__compressed_pair<std::pair<float __attribute__((ext_vector_type(2))), float __attribute__((ext_vector_type(2)))> *, std::allocator<std::pair<float __attribute__((ext_vector_type(2))), float __attribute__((ext_vector_type(2)))>>>="__value_"^v {}  mNonCollisionSegments;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })regionWithVertices:(struct vector<Vertex, std::allocator<Vertex>> { struct Vertex {} *x1; struct Vertex {} *x2; struct __compressed_pair<Vertex *, std::allocator<Vertex>> { struct Vertex {} *x_3_1_1; } x3; })arg1 withInflationAmount:(float)arg2;
...
- (void)updateVertexControllerWithData:(struct vector<Vertex, std::allocator<Vertex>> { struct Vertex {} *x1; struct Vertex {} *x2; struct __compressed_pair<Vertex *, std::allocator<Vertex>> { struct Vertex {} *x_3_1_1; } x3; })arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 allowWet:(bool)arg3;
