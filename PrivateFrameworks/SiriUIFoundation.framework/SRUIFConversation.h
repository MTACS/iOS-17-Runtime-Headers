...
@interface SRUIFConversation : NSObject {
    ...
    <SRUIFConversationDelegate> * _delegate;
    NSUUID * _identifier;
    NSString * _languageCode;
    <SRUIFConversationStorable> * _lastRestoredItem;
    SRUIFTreeNode * _rootNode;
    bool  _synchronizedWithServer;
    NSMutableDictionary * _updatedUserUtteranceForRefId;
}

@property (nonatomic) <SRUIFConversationDelegate> *delegate;
@property (nonatomic, readonly, copy) NSUUID *identifier;
@property (nonatomic, readonly, copy) NSString *languageCode;
@property (setter=_setLastRestoredItem:, nonatomic, retain) <SRUIFConversationStorable> *lastRestoredItem;
@property (getter=_rootNode, setter=_setRootNode:, nonatomic, retain) SRUIFTreeNode *rootNode;
