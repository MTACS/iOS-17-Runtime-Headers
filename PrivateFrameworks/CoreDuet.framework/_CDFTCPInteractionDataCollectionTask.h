...
@interface _CDFTCPInteractionDataCollectionTask : NSObject {
    ...
    _CDFTCPInteractionDataCollectionSession * _session;
    NSString * _sessionPath;
    unsigned long long  _twoWeekPeriodsInLookback;
}
...
@property (nonatomic, retain) _CDFTCPInteractionDataCollectionSession *session;
@property (nonatomic, readonly, copy) NSString *sessionPath;
@property (nonatomic, readonly) unsigned long long twoWeekPeriodsInLookback;
...
- (id)initWithStore:(id)arg1 activity:(id)arg2 sessionPath:(id)arg3 collectionDate:(id)arg4 samplingRate:(double)arg5 maxBatches:(unsigned long long)arg6 daysPerBatch:(unsigned long long)arg7 twoWeekPeriodsInLookback:(unsigned long long)arg8;
- (id)interactionStore;
...
- (unsigned long long)twoWeekPeriodsInLookback;
