...
+ (id)copyBase64HeaderValueFromData:(id)arg1;
...
+ (struct __SecKey { }*)copyKeyFromKeychainWithIdentifier:(id)arg1;
+ (id)copyNetworkDescription:(id)arg1;
+ (id)copyTrueClientIPAddressFromPreferences;
+ (id)createMaskedIPv4Address:(id)arg1 prefix:(unsigned long long)arg2;
+ (id)createMaskedIPv6Address:(id)arg1 prefix:(unsigned long long)arg2;
...
+ (void)removeKeyFromKeychainWithIdentifier:(id)arg1;
+ (bool)rollDiceWithSuccessRatio:(id)arg1;
+ (void)saveDataToKeychain:(id)arg1 withIdentifier:(id)arg2 accountName:(id)arg3;
+ (void)saveKeyToKeychain:(struct __SecKey { }*)arg1 withIdentifier:(id)arg2;
...
+ (unsigned long long)totalDataInKeychainWithIdentifier:(id)arg1;
