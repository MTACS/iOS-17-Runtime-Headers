...
@interface PXPlacesMapController : NSObject <CLLocationManagerDelegate, PXPlacesGeotaggedItemDataSourceDelegate, PXPlacesMapViewDelegate> {
    ...
    bool  _enableLocationAuthorizationMonitoring;
...
@property (nonatomic, readonly) bool enableLocationAuthorizationMonitoring;
...
- (id)dataSources;
- (void)dealloc;
- (bool)enableLocationAuthorizationMonitoring;
