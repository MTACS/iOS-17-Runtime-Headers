...
@property (nonatomic, readonly) NSLayoutConstraint *descriptionTrailingConstraint;
...
@property (nonatomic, readonly) NSLayoutConstraint *titleTrailingConstraint;
...
- (id)descriptionLabel;
- (id)descriptionText;
- (id)descriptionTrailingConstraint;
