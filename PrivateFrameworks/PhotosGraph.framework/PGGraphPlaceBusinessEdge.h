...
- (id)initFromMomentNode:(id)arg1 toBusinessNode:(id)arg2 confidence:(double)arg3 hasRoutineInfo:(bool)arg4 universalStartDate:(id)arg5 universalEndDate:(id)arg6;
