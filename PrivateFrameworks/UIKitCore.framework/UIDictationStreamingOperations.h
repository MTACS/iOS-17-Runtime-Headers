...
- (bool)isNotEmpty;
- (id)operations;
- (void)performSelectRangeForSpeech:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (id)pop;
- (void)popAndInvoke;
...
- (void)pushSpeechOperationWithSelectionChangeDelta:(long long)arg1 block:(id /* block */)arg2;
