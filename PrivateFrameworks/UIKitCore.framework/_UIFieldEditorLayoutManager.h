...
- (long long)_generateBulletGlyphs:(const unsigned short*)arg1 properties:(const long long*)arg2 characterIndexes:(const unsigned long long*)arg3 font:(id)arg4 forGlyphRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5 unobscuredRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg6;
