...
- (void)_calculateRectsUsingTextLayoutManager:(id)arg1;
- (void)_calculateTotalRect;
- (void)_coalesceRectsForRects:(id)arg1;
...
- (id)initWithTextContainer:(id)arg1 range:(id)arg2 unifyRects:(bool)arg3;
