...
- (void)_addGestureRecognizersForGestureOwner:(id)arg1 toTouch:(id)arg2 forContinuation:(bool)arg3;
...
- (void)_collectGestureRecognizersForGestureOwner:(id)arg1 withBlock:(id /* block */)arg2;
- (bool)_containsHIDPointerEvent;
