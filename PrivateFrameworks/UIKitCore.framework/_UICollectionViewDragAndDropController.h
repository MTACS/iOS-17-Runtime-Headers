...
@property (nonatomic, retain) NSMutableSet *cellsDeferredForReuse;
...
@property (nonatomic, readonly) unsigned long long reorderedItemCount;
...
- (bool)isCellInvolvedInDragOrDropAnimationAtIndexPath:(id)arg1;
...
- (unsigned long long)reorderedItemCount;
- (id)reorderedItems;
