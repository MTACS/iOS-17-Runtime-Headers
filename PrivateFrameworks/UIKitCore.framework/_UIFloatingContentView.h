...
@interface _UIFloatingContentView : UIView {
    ...
    bool  _forwardsSubviewIntrinsicContentSizeInvalidationsToSuperview;
...
@property (nonatomic, retain) _UIFloatingMotionConfiguration *contentMotion;
...
@property (nonatomic) struct CGPoint { double x1; double x2; } highContrastFocusIndicatorOutset;
...
@property (nonatomic, readonly) UIView *transformView;
...
- (struct CGPoint { double x1; double x2; })highContrastFocusIndicatorOutset;
...
- (void)setForwardsSubviewIntrinsicContentSizeInvalidationsToSuperview:(bool)arg1;
- (void)setFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)setHighContrastFocusIndicatorCornerRadius:(double)arg1;
- (void)setHighContrastFocusIndicatorOutset:(struct CGPoint { double x1; double x2; })arg1;
