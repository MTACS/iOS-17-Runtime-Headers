...
@interface ETGLSketchView : UIView <ETGLSketchRendererDelegate> {
    ...
    struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>>="__begin_"^"__end_"^"__end_cap_"{__compressed_pair<float * __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>>="__value_"^ {}  _controlBatches;
    ...
    struct vector<std::vector<float __attribute__((ext_vector_type(2)))>, std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>="__begin_"^v"__end_"^v"__end_cap_"{__compressed_pair<std::vector<float __attribute__((ext_vector_type(2)))> *, std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>="__value_"^v {}  _vertexBatches;
    unsigned long long  _vertexOffset;
    double  _wispDelay;
}

@property (nonatomic, retain) EAGLContext *context;
@property (nonatomic) /* Warning: unhandled struct encoding: '{vector<float __attribute__((ext_vector_type(2)))' */ struct  controlBatches; /* unknown property attribute:  std::allocator<float __attribute__((ext_vector_type(2)))>>=^}} */
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{vector<unsigned long' */ struct  secondaryVertexBatchCount; /* unknown property attribute:  std::allocator<unsigned long>>=^Q}} */
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{vector<unsigned long' */ struct  vertexBatchCount; /* unknown property attribute:  std::allocator<unsigned long>>=^Q}} */
@property (nonatomic) /* Warning: unhandled struct encoding: '{vector<std::vector<float __attribute__((ext_vector_type(2)))>' */ struct  vertexBatches; /* unknown property attribute:  std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>=^v}} */
...
- (void)clearAllPoints;
- (id)context;
- (struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>>=^^{__compressed_pair<float * __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>>=^ {})controlBatches;
...
- (struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x1; unsigned long long *x2; struct __compressed_pair<unsigned long *, std::allocator<unsigned long>> { unsigned long long *x_3_1_1; } x3; })secondaryVertexBatchCount;
- (void)setContext:(id)arg1;
- (void)setControlBatches:(struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>>=^^{__compressed_pair<float * __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>>=^ {})arg1;
...
- (void)setSecondaryVertexBatchCount:(struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x1; unsigned long long *x2; struct __compressed_pair<unsigned long *, std::allocator<unsigned long>> { unsigned long long *x_3_1_1; } x3; })arg1;
...
- (void)setVertexBatchCount:(struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x1; unsigned long long *x2; struct __compressed_pair<unsigned long *, std::allocator<unsigned long>> { unsigned long long *x_3_1_1; } x3; })arg1;
- (void)setVertexBatches:(struct vector<std::vector<float __attribute__((ext_vector_type(2)))>, std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>=^v^v{__compressed_pair<std::vector<float __attribute__((ext_vector_type(2)))> *, std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>=^v {})arg1;
...
- (struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x1; unsigned long long *x2; struct __compressed_pair<unsigned long *, std::allocator<unsigned long>> { unsigned long long *x_3_1_1; } x3; })vertexBatchCount;
- (struct vector<std::vector<float __attribute__((ext_vector_type(2)))>, std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>=^v^v{__compressed_pair<std::vector<float __attribute__((ext_vector_type(2)))> *, std::allocator<std::vector<float __attribute__((ext_vector_type(2)))>>>=^v {})vertexBatches;
