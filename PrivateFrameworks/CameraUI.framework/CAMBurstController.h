...
@interface CAMBurstController : NSObject {
    ...
    NSMutableDictionary * __analyticsEventsByIdentifier;
...
@property (nonatomic, readonly) NSMutableDictionary *_analyticsEventsByIdentifier;
...
- (id)_activeSession;
- (id)_analysisQueue;
- (id)_analyticsEventsByIdentifier;
...
- (id)startBurstCaptureWithAnalyticsEvent:(id)arg1;
