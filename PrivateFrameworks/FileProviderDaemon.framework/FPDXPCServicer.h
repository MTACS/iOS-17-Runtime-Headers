...
- (void).cxx_destruct;
- (void)_checkEnumerationPermissionsForSettings:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)addDomain:(id)arg1 forProviderIdentifier:(id)arg2 byImportingDirectoryAtURL:(id)arg3 nonWrappedURL:(id)arg4 knownFolders:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)startAccessingServiceWithName:(id)arg1 itemID:(id)arg2 connection:(id)arg3 enumerateEntitlementRequired:(bool)arg4 completionHandler:(id /* block */)arg5;
