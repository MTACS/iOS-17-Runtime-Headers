...
@interface HMVEventWriterImplementation : NSObject

+ (void)clearEventsWithHomeIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
+ (void)writeFakeEventsWithDate:(id)arg1 homeIdentifier:(id)arg2 count:(long long)arg3 completion:(id /* block */)arg4;
