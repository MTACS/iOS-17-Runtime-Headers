...
@property (nonatomic, retain) NSEnumerator *conflictedKeysEnumerator;
@property (nonatomic, retain) NSEnumerator *deletedKeysEnumerator;
@property (nonatomic) bool resolvedConflictsNeedSyncToServer;
@property (nonatomic, retain) SBKSyncResponseData *responseData;
@property (nonatomic, retain) SBKSyncTransaction *transaction;
@property (nonatomic, retain) NSEnumerator *updatedKeysEnumerator;
