...
@property (nonatomic, retain) SBKAsynchronousTask *bagLookupTask;
@property (nonatomic, retain) SBKAsynchronousTask *currentTask;
@property (nonatomic, retain) SBKRequestHandler *currentTaskRequestHandler;
@property (nonatomic, readonly) <SBKUniversalPlaybackPositionDataSource> *dataSource;
@property (nonatomic, retain) NSDate *dateToFireNextTimer;
@property (nonatomic) bool hasLocalChangesToSync;
@property (nonatomic, retain) SBKAsynchronousTask *lookupDomainVersionTask;
