...
@property (nonatomic, readonly) long long conflictDetectionType;
@property (nonatomic, readonly) NSArray *keysToDelete;
@property (nonatomic, readonly) NSArray *keysToUpdate;
@property (nonatomic, readonly, copy) NSString *syncAnchor;
@property (nonatomic, readonly) NSURL *syncRequestURL;
@property (nonatomic) <SBKSyncTransactionProcessing> *transactionProcessor;
