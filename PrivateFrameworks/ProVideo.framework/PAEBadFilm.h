...
- (void)createDust:(int)arg1 scratches:(int)arg2 scratchColor:(double*)arg3 hair:(int)arg4 randomSeed:(int)arg5 autoRandFreq:(int)arg6 buffer:(void*)arg7 atTime:(union { double x1; struct { /* ? */ } *x2; })arg8 pixelTransform:(const void*)arg9;
- (void)dealloc;
