...
- (bool)addParameters;
- (struct HGRef<HGNode> { struct HGNode {} *x1; })blurNodeWithRadius:(double)arg1 xScale:(double)arg2 yScale:(double)arg3 inputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg4;
- (struct HGRef<HGNode> { struct HGNode {} *x1; })brightnessNodeWithValue:(double)arg1 inputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg2;
