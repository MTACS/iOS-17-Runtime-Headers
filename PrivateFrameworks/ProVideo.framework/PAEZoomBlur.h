...
- (void)polarToRect:(id)arg1 withInputImage:(id)arg2 withInputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg3 centerX:(double)arg4 centerY:(double)arg5 upscaleFactor:(double)arg6 andOutputNode:(void*)arg7;
- (id)properties;
- (void)rectToPolar:(id)arg1 withInputImage:(id)arg2 withInputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg3 centerX:(double)arg4 centerY:(double)arg5 upscaleFactor:(double)arg6 andOutputNode:(void*)arg7;
