...
- (bool)addParameters;
- (struct HGRef<HGNode> { struct HGNode {} *x1; })changeDOD:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg1 withRect:(const void*)arg2;
- (struct PCVector2<double> { double x1; double x2; })convertRelativeToImageCoordinates:(const void*)arg1 withImage:(id)arg2;
- (struct PCVector2<double> { double x1; double x2; })convertRelativeToPixelCoordinates:(const void*)arg1 withImage:(id)arg2;
- (void)crop:(void*)arg1 fromImage:(id)arg2 toImage:(id)arg3;
- (void)crop:(void*)arg1 withRect:(struct PCRect<float> { float x1; float x2; float x3; float x4; })arg2;
...
- (bool)getCropRectFromImage:(id)arg1 toImage:(id)arg2 output:(void*)arg3;
...
- (bool)getPoint:(void*)arg1 fromParm:(unsigned int)arg2 atTime:(union { double x1; struct { /* ? */ } *x2; })arg3 withImage:(id)arg4;
...
- (bool)smear:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg1 fromImage:(id)arg2 toImage:(id)arg3 resultNode:(void*)arg4;
- (void)transform:(void*)arg1 fromImage:(id)arg2 toImage:(id)arg3 fit:(bool)arg4;
