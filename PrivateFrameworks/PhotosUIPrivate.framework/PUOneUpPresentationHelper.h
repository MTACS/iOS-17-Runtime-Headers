...
- (void)_presentOneUpViewController:(id)arg1 animated:(bool)arg2 interactiveMode:(long long)arg3 activity:(unsigned long long)arg4 completion:(id /* block */)arg5;
...
- (void)presentOneUpViewControllerAnimated:(bool)arg1 interactiveMode:(long long)arg2 activity:(unsigned long long)arg3;
- (void)presentOneUpViewControllerFromAssetAtIndexPath:(id)arg1 animated:(bool)arg2 interactiveMode:(long long)arg3 activity:(unsigned long long)arg4;
