...
@interface PUVideoListViewController : PUStorageManagementBaseController <PUOneUpPresentationHelperAssetDisplayDelegate, PUOneUpPresentationHelperDelegate, PUVideoListAssetExpungeActionPerformerDelegate, PXPhotoKitDeletePhotosActionControllerDelegate, PXPhotosDataSourceChangeObserver, UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate> {
...
- (id)oneUpPresentationHelper:(id)arg1 regionOfInterestForAssetReference:(id)arg2 cropInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; }*)arg3 contentsRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg4;
