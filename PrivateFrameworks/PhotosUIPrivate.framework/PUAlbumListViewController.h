...
@interface PUAlbumListViewController : UIViewController <PHPickerViewControllerDelegate, PLCloudFeedNavigating, PUAlbumListTableViewCellDelegate, PUCollectionViewReorderDelegate, PUCollectionsCollectionViewDropDataProvider, PUSectionedGridLayoutDelegate, PUStackedAlbumControllerTransition, PUStackedAlbumTransitionDelegate, PXChangeObserver, PXCollectionActionReceiver, PXCollectionsDataSourceManagerObserver, PXEditableNavigationTitleViewDelegate, PXForcedDismissableViewController, PXNavigableCollectionContainer, PXNavigableSharedAlbumActivityFeedHostViewController, PXPhotoLibraryUIChangeObserver, PXPlacesSnapshotFactoryDelegate, UIAdaptivePresentationControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
...
+ (id)newSharedAlbumsViewControllerWithSpec:(id)arg1 sessionInfo:(id)arg2 dataSourceManager:(id)arg3 photoLibrary:(id)arg4;
+ (id)newSharedAlbumsViewControllerWithSpec:(id)arg1 sessionInfo:(id)arg2 photoLibrary:(id)arg3;
