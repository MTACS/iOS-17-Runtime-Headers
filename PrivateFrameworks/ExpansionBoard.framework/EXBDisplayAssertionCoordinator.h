...
@interface EXBDisplayAssertionCoordinator : NSObject <EXBDisplayAssertionProviding, _EXBDisplayAssertionStackDelegate> {
    NSMutableDictionary * _assertionPreferencesMap;
    NSMutableDictionary * _assertionStackMap;
    <EXBDisplayAssertionCoordinatorDelegate> * _delegate;
}

@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) <EXBDisplayAssertionCoordinatorDelegate> *delegate;
