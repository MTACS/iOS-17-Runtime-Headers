...
- (id)_reasonsForRejectingAutoRouteOrOneTapClassificationForCandidate:(id)arg1 isAutoRoutingSettingEnabled:(bool)arg2 isRoutePredictionSettingEnabled:(bool)arg3;
