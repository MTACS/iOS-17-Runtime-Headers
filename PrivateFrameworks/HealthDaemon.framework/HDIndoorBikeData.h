...
+ (id)unitTest_fakeIndoorBikeDataForInstantaneousCadence:(double)arg1 averageCadence:(double)arg2 instantaneousSpeed:(double)arg3 totalDistance:(unsigned int)arg4 instantaneousPower:(short)arg5 averagePower:(short)arg6 energy:(unsigned short)arg7 elapsedTime:(unsigned short)arg8;
+ (id)uuid;
