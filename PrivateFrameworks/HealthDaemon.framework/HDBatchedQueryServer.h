...
- (long long)batchObjectsWithMultitypeQueryCursor:(id)arg1 includeDeletedObjects:(bool)arg2 limit:(unsigned long long)arg3 error:(id*)arg4 batchHandler:(id /* block */)arg5;
