...
@interface HDGymKitDataSource : HDStandardTaskServer <HDWorkoutDataDestination, HDWorkoutDataSource, HKDataFlowLinkProcessor, HKGymKitDataSourceServerInterface, HKLiveWorkoutDataSourceServerInterface> {
