...
@property (nonatomic, readonly) const void*label;
...
- (const void*)label;
- (void)layoutForStagingWithNavContext:(struct NavContext { int (**x1)(); struct LabelManager {} *x2; struct MapNavLabeler {} *x3; struct LabelLayoutContext {} *x4; struct LabelNavLayoutContext {} *x5; }*)arg1;
