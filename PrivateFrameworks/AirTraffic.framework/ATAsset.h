...
@interface ATAsset : NSObject <NSCopying, NSSecureCoding> {
    ...
    NMSDownloadableItem * _mediaItemDownloadInfo;
    bool  _powerRequired;
...
@property (nonatomic, retain) NMSDownloadableItem *mediaItemDownloadInfo;
...
- (void)setCanProxyUseCellularData:(bool)arg1;
...
- (void)setDeviceWasChargingWhenEnqueued:(bool)arg1;
