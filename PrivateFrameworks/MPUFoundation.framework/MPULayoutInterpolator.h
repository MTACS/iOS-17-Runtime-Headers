...
- (struct vector<MPU::Point3D, std::allocator<MPU::Point3D>> { struct Point3D {} *x1; struct Point3D {} *x2; struct __compressed_pair<MPU::Point3D *, std::allocator<MPU::Point3D>> { struct Point3D {} *x_3_1_1; } x3; })_sortedPointsFor3DInterpolationFromEntriesContainer:(void*)arg1 usingQueriedPoint:(struct Point3D { double x1; double x2; double x3; })arg2 fallbackSecondaryReferenceMetric:(double)arg3;
