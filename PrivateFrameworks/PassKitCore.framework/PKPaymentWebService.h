...
- (unsigned long long)_passActionWithRemoteContentPassAction:(id)arg1 encryptedServiceProviderData:(id)arg2 forDeviceIdentifier:(id)arg3 passTypeIdentifier:(id)arg4 passSerialNumber:(id)arg5 completion:(id /* block */)arg6;
- (unsigned long long)_passActionWithRemoteContentPassAction:(id)arg1 forDeviceIdentifier:(id)arg2 passTypeIdentifier:(id)arg3 passSerialNumber:(id)arg4 completion:(id /* block */)arg5;
...
- (unsigned long long)passActionWithRemoteContentPassAction:(id)arg1 encryptedServiceProviderData:(id)arg2 forDeviceIdentifier:(id)arg3 passTypeIdentifier:(id)arg4 passSerialNumber:(id)arg5 completion:(id /* block */)arg6;
