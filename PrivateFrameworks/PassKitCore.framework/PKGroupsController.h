...
- (id)_displayablePassesDictionaryFromSet:(id)arg1 withCatalog:(id)arg2;
...
- (void)_updateStateWithCatalog:(id)arg1 passes:(id)arg2 annotations:(id)arg3 notify:(bool)arg4;
- (void)_updateStateWithCatalog:(id)arg1 passes:(id)arg2 displayablePasses:(id)arg3 notify:(bool)arg4;
...
- (void)getSnapshotWithOptions:(id)arg1 synchronously:(bool)arg2 handler:(id /* block */)arg3;
...
- (id)passes;
- (void)processFetchedSnapshot:(id)arg1 withOptions:(id)arg2 synchronously:(bool)arg3 notify:(bool)arg4 completion:(id /* block */)arg5;
- (void)reloadGroups;
...
- (void)updateStateWithSnapshot:(id)arg1 options:(id)arg2 notify:(bool)arg3;
