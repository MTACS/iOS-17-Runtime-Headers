...
@interface _MPCQueueControllerBehaviorMusic2 : NSObject <MPArtworkDataSource, MPCContinueListeningRadioQueueProviding, MPCQueueControllerBehaviorDynamicLoadingImplementation, MPCQueueControllerBehaviorMusic, MPCQueueControllerBehaviorRestorableImplementation, MPCQueueControllerBehaviorTransportableImplementation, MPCQueueControllerBehaviorUpNextImplementation, MPSectionedIdentifierListAnnotationDelegate, MPShuffleableSectionedIdentifierListDelegate> {
    ...
    long long  _state;
    _MPCQueueControllerBehaviorMusic_Swift * _swift;
}
...
@property (nonatomic, readonly) _MPCQueueControllerBehaviorMusic_Swift *swift;
