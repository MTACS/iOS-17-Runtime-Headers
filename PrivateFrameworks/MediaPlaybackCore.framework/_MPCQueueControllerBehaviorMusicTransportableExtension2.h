...
@interface _MPCQueueControllerBehaviorMusicTransportableExtension2 : NSObject <MPCPlaybackAccountManagerObserver, MPCQueueControllerBehaviorTransportableExtension> {
    NSArray * _accounts;
