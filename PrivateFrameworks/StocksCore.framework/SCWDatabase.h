...
@interface SCWDatabase : NSObject <SCWDatabaseStoreCoordinatorObserver> {
    ...
    SCWAsyncSerialQueue * _ckSyncQueue;
    <SCWContainerProxying> * _container;
    NSArray * _mergeHandlers;
    NSMutableDictionary * _observersByZoneName;
    struct os_unfair_lock_s { 
        unsigned int _os_unfair_lock_opaque; 
    }  _observersLock;
    SCWDatabaseSchema * _schema;
    SCWStartupQueue * _startupQueue;
    long long  _status;
    <SCWDatabaseStoreCoordinator> * _storeCoordinator;
    NSMutableDictionary * _zoneSnapshotsByZoneName;
}

@property (nonatomic, retain) NSObject<OS_dispatch_queue> *callbackQueue;
@property (nonatomic, retain) SCWAsyncSerialQueue *ckSyncQueue;
@property (nonatomic, retain) <SCWContainerProxying> *container;
...
@property (nonatomic, retain) SCWDatabaseSchema *schema;
@property (nonatomic, retain) SCWStartupQueue *startupQueue;
@property long long status;
@property (nonatomic, retain) <SCWDatabaseStoreCoordinator> *storeCoordinator;
