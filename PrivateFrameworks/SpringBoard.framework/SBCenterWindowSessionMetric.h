...
@property (nonatomic, copy) NSString *centerBundleIdentifier;
...
- (bool)_sendCoreAnalyticsEventWithStartReason:(id)arg1 endReason:(id)arg2 duration:(double)arg3 centerBundleIdentifier:(id)arg4 doNotDisturbActive:(bool)arg5 hardwareKeyboardAttached:(bool)arg6;
