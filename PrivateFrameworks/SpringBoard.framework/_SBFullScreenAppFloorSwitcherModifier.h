...
- (void).cxx_destruct;
- (bool)_isLayoutRoleBehindCenterWindow:(long long)arg1 appLayout:(id)arg2;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })frameForAppLayout:(id)arg1;
