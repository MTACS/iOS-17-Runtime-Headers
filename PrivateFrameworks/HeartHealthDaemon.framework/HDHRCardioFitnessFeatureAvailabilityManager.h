...
@interface HDHRCardioFitnessFeatureAvailabilityManager : NSObject <HDFeatureAvailabilityExtension, HDHRRegionSupportedDeterminer> {
    ...
    <HDFeatureAvailabilityExtension> * _manager;
    HDProfile * _profile;
...
+ (id)makeRegionAvailabilityProviderWithProfile:(id)arg1;
...
- (id)initWithProfile:(id)arg1 regionAvailabilityProvider:(id)arg2 heartRateSettingsDefaults:(id)arg3;
- (id)initWithProfile:(id)arg1 regionAvailabilityProvider:(id)arg2 heartRateSettingsDefaults:(id)arg3 featureAvailabilityManager:(id)arg4;
