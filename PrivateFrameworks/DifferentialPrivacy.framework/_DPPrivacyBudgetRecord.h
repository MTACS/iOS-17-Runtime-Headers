...
- (id)initWithKey:(id)arg1 creationDate:(double)arg2 lastUpdate:(double)arg3 balance:(long long)arg4 cohortAggregateBalance:(double)arg5 objectId:(id)arg6;
...
- (void)setCohortAggregateBalance:(double)arg1;
