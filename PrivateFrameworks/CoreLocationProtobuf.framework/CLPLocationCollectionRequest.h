...
@property (nonatomic, readonly) bool hasPipelineMetadata;
...
@property (nonatomic, retain) CLPLocationProcessingPipelineMetadata *pipelineMetadata;
...
- (void)setPipelineMetadata:(id)arg1;
