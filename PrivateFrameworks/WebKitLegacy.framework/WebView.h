...
- (struct Vector<WTF::String, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct String {} *x1; unsigned int x2; unsigned int x3; })_dictationAlternatives:(struct ObjectIdentifierGeneric<WebCore::DictationContextType, WTF::ObjectIdentifierMainThreadAccessTraits> { unsigned long long x1; })arg1;
...
- (void)_removeDictationAlternatives:(struct ObjectIdentifierGeneric<WebCore::DictationContextType, WTF::ObjectIdentifierMainThreadAccessTraits> { unsigned long long x1; })arg1;
