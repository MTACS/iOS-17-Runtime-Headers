...
- (bool)_createLocalSocketWithNetworkConfig:(id)arg1;
- (bool)_initializeLocalStreamWithLocalNetworkConfig:(id)arg1;
- (bool)_initializeStreamRemoteDestinationReceiver:(id)arg1;
- (bool)_initializeStreamRemoteSender:(id)arg1 localNetworkConfig:(id)arg2;
