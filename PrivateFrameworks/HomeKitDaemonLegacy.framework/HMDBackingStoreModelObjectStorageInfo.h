...
@property (nonatomic, readonly) NSSet *decodeClasses;
...
- (id)description;
- (id)initWithClass:(Class)arg1 logging:(unsigned long long)arg2 readOnly:(id)arg3 unavailable:(id)arg4 defaultSet:(bool)arg5 defaultValue:(id)arg6 additonalDecodeClasses:(id)arg7;
