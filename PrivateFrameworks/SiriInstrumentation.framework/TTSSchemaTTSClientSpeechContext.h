...
@property (nonatomic, retain) TTSSchemaTTSSpeechCancelled *cancelled;
@property (nonatomic, retain) SISchemaUUID *contextId;
@property (nonatomic, retain) TTSSchemaTTSSpeechEnded *ended;
@property (nonatomic, retain) TTSSchemaTTSSpeechFailed *failed;
...
@property (nonatomic, retain) TTSSchemaTTSSpeechStarted *startedOrChanged;
