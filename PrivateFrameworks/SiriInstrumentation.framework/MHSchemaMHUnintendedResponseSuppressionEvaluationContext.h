...
@property (nonatomic, retain) MHSchemaMHUnintendedResponseSuppressionEnded *ended;
@property (nonatomic, retain) MHSchemaMHUnintendedResponseSuppressionFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) MHSchemaMHUnintendedResponseSuppressionStarted *startedOrChanged;
