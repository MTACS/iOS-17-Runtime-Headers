...
@property (nonatomic, retain) CNVSchemaCNVIntentReformationEnded *ended;
@property (nonatomic, retain) CNVSchemaCNVIntentReformationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CNVSchemaCNVIntentReformationStarted *startedOrChanged;
