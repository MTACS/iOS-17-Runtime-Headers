...
@property (nonatomic, retain) CNVSchemaCNVDisambiguationFollowupHandled *ended;
@property (nonatomic, retain) CNVSchemaCNVDisambiguationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CNVSchemaCNVDisambiguationDialogGenerated *startedOrChanged;
