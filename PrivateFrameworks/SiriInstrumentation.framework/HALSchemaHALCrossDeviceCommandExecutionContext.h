...
@property (nonatomic, retain) HALSchemaHALCrossDeviceCommandExecutionEnded *ended;
@property (nonatomic, retain) HALSchemaHALCrossDeviceCommandExecutionFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) HALSchemaHALCrossDeviceCommandExecutionStarted *startedOrChanged;
