...
@property (nonatomic, retain) HALSchemaHALContextCollectorFetchEnded *ended;
@property (nonatomic, retain) HALSchemaHALContextCollectorFetchFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) HALSchemaHALContextCollectorFetchStarted *startedOrChanged;
