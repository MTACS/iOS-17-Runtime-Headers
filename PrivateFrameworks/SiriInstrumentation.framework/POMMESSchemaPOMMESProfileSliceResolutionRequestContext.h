...
@property (nonatomic, retain) POMMESSchemaPOMMESProfileSliceResolutionRequestEnded *ended;
@property (nonatomic, retain) POMMESSchemaPOMMESProfileSliceResolutionRequestFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) POMMESSchemaPOMMESProfileSliceResolutionRequestStarted *startedOrChanged;
