...
@property (nonatomic, retain) PLUSSchemaPLUSContactSuggesterQueryResponseReceived *ended;
@property (nonatomic, retain) PLUSSchemaPLUSContactSuggesterQueryFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) PLUSSchemaPLUSContactSuggesterQueryStarted *startedOrChanged;
