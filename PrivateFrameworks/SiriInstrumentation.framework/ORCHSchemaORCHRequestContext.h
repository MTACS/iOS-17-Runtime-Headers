...
@property (nonatomic, retain) ORCHSchemaORCHRequestCancelled *cancelled;
@property (nonatomic, retain) ORCHSchemaORCHRequestEnded *ended;
@property (nonatomic, retain) ORCHSchemaORCHRequestFailed *failed;
@property (nonatomic) bool hasCancelled;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ORCHSchemaORCHRequestStarted *startedOrChanged;
