...
@property (nonatomic, retain) SISchemaUEIDictationDiscoveryToolTipDismissed *ended;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) SISchemaUEIDictationDiscoveryToolTipShown *startedOrChanged;
