...
@property (nonatomic, retain) CLPInstSchemaCLPCurareAppIntentSampleClassificationEnded *ended;
@property (nonatomic, retain) CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CLPInstSchemaCLPCurareAppIntentSampleClassificationStarted *startedOrChanged;
