...
@property (nonatomic, retain) MHSchemaMHLatticeFalseTriggerMitigationEnded *ended;
@property (nonatomic, retain) MHSchemaMHLatticeFalseTriggerMitigationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) MHSchemaMHLatticeFalseTriggerMitigationStarted *startedOrChanged;
