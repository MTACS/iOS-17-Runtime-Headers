...
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKActionConversionEnded *ended;
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKActionConversionFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKActionConversionStarted *startedOrChanged;
