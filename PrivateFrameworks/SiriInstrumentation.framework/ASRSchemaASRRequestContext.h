...
@property (nonatomic, retain) ASRSchemaASRCancelled *cancelled;
@property (nonatomic, retain) ASRSchemaASREnded *ended;
@property (nonatomic, retain) ASRSchemaASRFailed *failed;
@property (nonatomic) bool hasCancelled;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ASRSchemaASRStarted *startedOrChanged;
