...
@property (nonatomic, retain) MTSchemaMTInvocationCancelled *cancelled;
@property (nonatomic, retain) MTSchemaMTInvocationEnded *ended;
@property (nonatomic, retain) MTSchemaMTInvocationFailed *failed;
@property (nonatomic) bool hasCancelled;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) MTSchemaMTInvocationStarted *startedOrChanged;
