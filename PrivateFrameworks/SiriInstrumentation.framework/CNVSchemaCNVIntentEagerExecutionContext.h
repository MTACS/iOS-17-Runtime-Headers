...
@property (nonatomic, retain) CNVSchemaCNVIntentEagerExecutionCancelled *cancelled;
@property (nonatomic, retain) CNVSchemaCNVIntentEagerExecutionEnded *ended;
@property (nonatomic, retain) CNVSchemaCNVIntentEagerExecutionFailed *failed;
@property (nonatomic) bool hasCancelled;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CNVSchemaCNVIntentEagerExecutionStarted *startedOrChanged;
