...
@property (nonatomic, retain) CLPInstSchemaCLPCDMReplaySampleEnded *ended;
@property (nonatomic, retain) CLPInstSchemaCLPCDMReplaySampleFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CLPInstSchemaCLPCDMReplaySampleStarted *startedOrChanged;
