...
@property (nonatomic, retain) RRSchemaRREntityPoolResolveEnded *ended;
@property (nonatomic, retain) RRSchemaRREntityPoolResolveFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RRSchemaRREntityPoolResolveStarted *startedOrChanged;
