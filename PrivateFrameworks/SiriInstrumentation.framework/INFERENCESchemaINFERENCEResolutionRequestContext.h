...
@property (nonatomic, retain) INFERENCESchemaINFERENCEResolutionRequestEnded *ended;
@property (nonatomic, retain) INFERENCESchemaINFERENCEResolutionRequestFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) INFERENCESchemaINFERENCEResolutionRequestStarted *startedOrChanged;
