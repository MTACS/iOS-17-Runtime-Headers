...
@property (nonatomic, retain) RSSSchemaRSSSiriVocabSyncDataDownloadEnded *ended;
@property (nonatomic, retain) RSSSchemaRSSSiriVocabSyncDataDownloadFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RSSSchemaRSSSiriVocabSyncDataDownloadTriggered *startedOrChanged;
