...
@property (nonatomic, retain) ASRSchemaASRAppLanguageModelLoadEnded *ended;
@property (nonatomic, retain) ASRSchemaASRAppLanguageModelLoadFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ASRSchemaASRAppLanguageModelLoadStarted *startedOrChanged;
