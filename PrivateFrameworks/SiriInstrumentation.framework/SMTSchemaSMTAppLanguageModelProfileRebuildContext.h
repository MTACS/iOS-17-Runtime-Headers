...
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelProfileRebuildEnded *ended;
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelProfileRebuildFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelProfileRebuildStarted *startedOrChanged;
