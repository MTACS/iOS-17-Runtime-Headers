...
@property (nonatomic, retain) POMMESSchemaPOMMESOnDeviceIndexSearchEnded *ended;
@property (nonatomic, retain) POMMESSchemaPOMMESOnDeviceIndexSearchFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) POMMESSchemaPOMMESOnDeviceIndexSearchStarted *startedOrChanged;
