...
@property (nonatomic, retain) HALSchemaHALLocalFetchEnded *ended;
@property (nonatomic, retain) HALSchemaHALLocalFetchFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) HALSchemaHALLocalFetchStarted *startedOrChanged;
