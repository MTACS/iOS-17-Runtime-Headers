...
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKEntityDisambiguationEnded *ended;
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKEntityDisambiguationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKEntityDisambiguationStarted *startedOrChanged;
