...
@property (nonatomic, retain) HALSchemaHALForceFetchEnded *ended;
@property (nonatomic, retain) HALSchemaHALForceFetchFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) HALSchemaHALForceFetchStarted *startedOrChanged;
