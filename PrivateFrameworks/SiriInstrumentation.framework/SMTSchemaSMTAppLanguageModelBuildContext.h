...
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelBuildEnded *ended;
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelBuildFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelBuildStarted *startedOrChanged;
