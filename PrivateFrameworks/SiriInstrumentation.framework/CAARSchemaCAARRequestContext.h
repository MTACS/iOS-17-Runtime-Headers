...
@property (nonatomic, retain) CAARSchemaCAARResponseGenerated *ended;
@property (nonatomic, retain) CAARSchemaCAARRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CAARSchemaCAARRequestReceived *startedOrChanged;
