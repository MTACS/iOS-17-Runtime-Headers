...
@property (nonatomic, retain) MHSchemaMHDarwinConnectedDeviceWakeEnded *ended;
@property (nonatomic, retain) MHSchemaMHDarwinConnectedDeviceWakeFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) MHSchemaMHDarwinConnectedDeviceWakeStarted *startedOrChanged;
