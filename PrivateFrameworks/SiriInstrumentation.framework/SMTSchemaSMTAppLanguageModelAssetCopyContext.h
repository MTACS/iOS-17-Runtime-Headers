...
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelAssetCopyEnded *ended;
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelAssetCopyFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) SMTSchemaSMTAppLanguageModelAssetCopyStarted *startedOrChanged;
