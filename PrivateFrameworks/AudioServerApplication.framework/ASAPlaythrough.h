...
- (id)initWithDevices:(id)arg1 usingMainDevice:(id)arg2 andClockDevice:(id)arg3 withName:(id)arg4 isPrivate:(bool)arg5 usingChannelMapping:(id)arg6;
- (id)initWithDevices:(id)arg1 usingMainDevice:(id)arg2 andClockDeviceUID:(id)arg3 withName:(id)arg4 isPrivate:(bool)arg5 usingChannelMapping:(id)arg6;
