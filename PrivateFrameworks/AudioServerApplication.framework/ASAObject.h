...
- (bool)getMainGlobalProperty:(unsigned int)arg1 withData:(void*)arg2 ofSize:(unsigned int*)arg3 withQualifier:(void*)arg4 ofSize:(unsigned int)arg5;
- (bool)getMainInputProperty:(unsigned int)arg1 withData:(void*)arg2 ofSize:(unsigned int*)arg3 withQualifier:(void*)arg4 ofSize:(unsigned int)arg5;
- (bool)getMainOutputProperty:(unsigned int)arg1 withData:(void*)arg2 ofSize:(unsigned int*)arg3 withQualifier:(void*)arg4 ofSize:(unsigned int)arg5;
...
- (bool)hasMainGlobalProperty:(unsigned int)arg1;
- (bool)hasMainInputProperty:(unsigned int)arg1;
- (bool)hasMainOutputProperty:(unsigned int)arg1;
...
- (bool)isMainGlobalPropertySettable:(unsigned int)arg1;
- (bool)isMainInputPropertySettable:(unsigned int)arg1;
- (bool)isMainOutputPropertySettable:(unsigned int)arg1;
...
- (bool)onQueue:(id)arg1 forMainGlobalProperty:(unsigned int)arg2 addListener:(id /* block */)arg3;
- (bool)onQueue:(id)arg1 forMainGlobalProperty:(unsigned int)arg2 removeListener:(id /* block */)arg3;
- (bool)onQueue:(id)arg1 forMainInputProperty:(unsigned int)arg2 addListener:(id /* block */)arg3;
- (bool)onQueue:(id)arg1 forMainInputProperty:(unsigned int)arg2 removeListener:(id /* block */)arg3;
- (bool)onQueue:(id)arg1 forMainOutputProperty:(unsigned int)arg2 addListener:(id /* block */)arg3;
- (bool)onQueue:(id)arg1 forMainOutputProperty:(unsigned int)arg2 removeListener:(id /* block */)arg3;
...
- (bool)setMainGlobalProperty:(unsigned int)arg1 withData:(void*)arg2 ofSize:(unsigned int)arg3 withQualifier:(void*)arg4 ofSize:(unsigned int)arg5;
- (bool)setMainInputProperty:(unsigned int)arg1 withData:(void*)arg2 ofSize:(unsigned int)arg3 withQualifier:(void*)arg4 ofSize:(unsigned int)arg5;
- (bool)setMainOutputProperty:(unsigned int)arg1 withData:(void*)arg2 ofSize:(unsigned int)arg3 withQualifier:(void*)arg4 ofSize:(unsigned int)arg5;
...
- (unsigned int)sizeOfMainGlobalProperty:(unsigned int)arg1 withQualifier:(void*)arg2 ofSize:(unsigned int)arg3;
- (unsigned int)sizeOfMainInputProperty:(unsigned int)arg1 withQualifier:(void*)arg2 ofSize:(unsigned int)arg3;
- (unsigned int)sizeOfMainOutputProperty:(unsigned int)arg1 withQualifier:(void*)arg2 ofSize:(unsigned int)arg3;
