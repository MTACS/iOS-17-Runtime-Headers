...
@interface CSHybridEndpointer : NSObject <CSEndpointAnalyzerImpl, CSEndpointerAssetManagerDelegate> {
    ...
    bool  _enhancedEndpointerRelaxedResult;
    ...
    CSServerEndpointFeatures * _lastKnownRCFeatures;
    double  _lastKnownRCServerFeaturesLatency;
...
@property (nonatomic, retain) CSServerEndpointFeatures *lastKnownRCFeatures;
...
- (void)_shouldAcceptEagerResultForDuration:(double)arg1 serverFeatures:(id)arg2 lastReportedEndpointTimeMs:(double)arg3 osdFeatures:(id)arg4 resultsCompletionHandler:(id /* block */)arg5;
...
- (bool)enhancedEndpointerRelaxedResult;
...
- (double)lastKnownRCServerFeaturesLatency;
...
- (void)setEnhancedEndpointerRelaxedResult:(bool)arg1;
...
- (void)setLastKnownRCServerFeaturesLatency:(double)arg1;
