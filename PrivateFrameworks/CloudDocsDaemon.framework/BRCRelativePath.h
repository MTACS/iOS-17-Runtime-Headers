...
@interface BRCRelativePath : NSObject {
    ...
    NSString * _itemSyncPausedByBundleID;
    unsigned int  _itemSyncPausedByBundleIDResolved;
    NSNumber * _itemSyncPausedExpireTS;
    unsigned int  _itemSyncPausedExpireTSResolved;
    ...
    unsigned int  _unresolvableDueToProtection;
    NSData * _xattrs;
...
@property (nonatomic, readonly) bool isUnresolvableDueToProtection;
@property (nonatomic, readonly) bool isWritable;
@property (nonatomic) unsigned char itemScope;
@property (nonatomic, readonly) NSString *itemSyncPausedByBundleID;
@property (nonatomic, readonly) NSNumber *itemSyncPausedExpireTS;
...
- (id)itemSyncPausedByBundleID;
- (id)itemSyncPausedExpireTS;
- (id)logicalName;
- (id)logicalURL;
