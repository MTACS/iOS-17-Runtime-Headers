...
@interface BRCAccountSession : NSObject <BRCCloudDocsAppsObserver> {
    ...
    int  _ciconiaState;
    unsigned long long  _ciconiaVersion;
...
- (bool)_isExpectedCiconiaError:(id)arg1;
...
- (void)_reportFailedQueueingMigration:(id)arg1;
...
- (bool)shouldStartCiconiaBasedOnItemsCountWithAcountHash:(unsigned long long)arg1;
