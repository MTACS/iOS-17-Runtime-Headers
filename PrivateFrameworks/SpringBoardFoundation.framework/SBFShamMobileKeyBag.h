...
- (void)createStashBag:(id)arg1 skipSEKeepUserDataOperation:(bool)arg2 completion:(id /* block */)arg3;
- (void)createStashBag:(id)arg1 skipSEKeepUserDataOperation:(bool)arg2 completion:(id /* block */)arg3 completionQueue:(id)arg4;
- (id)extendedState;
