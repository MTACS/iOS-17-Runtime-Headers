...
- (void)setHasServingCellRAT:(bool)arg1;
- (void)setHasServingCellRSRP:(bool)arg1;
- (void)setHasServingCellSINR:(bool)arg1;
...
- (void)setServingCellRAT:(unsigned int)arg1;
- (void)setServingCellRSRP:(long long)arg1;
- (void)setServingCellSINR:(int)arg1;
