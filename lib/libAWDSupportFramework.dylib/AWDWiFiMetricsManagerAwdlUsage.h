...
- (void)setCachedPeersCapOther:(unsigned int)arg1;
...
- (void)setCachedPeersOnOther:(unsigned int)arg1;
...
- (void)setHasCachedPeersCapOther:(bool)arg1;
...
- (void)setHasCachedPeersOnOther:(bool)arg1;
...
- (void)setHasSelfCapOther:(bool)arg1;
...
- (void)setSelfCapOther:(unsigned int)arg1;
