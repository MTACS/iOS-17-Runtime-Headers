...
- (bool)needsDefaultAllDayAlarmUpdate;
- (bool)needsDefaultTimedAlarmUpdate;
...
- (void)setAlarmsDirty:(bool)arg1;
- (void)setDefaultAllDayAlarms:(NSString *)arg1;
- (void)setDefaultTimedAlarms:(NSString *)arg1;
- (void)setNeedsDefaultAllDayAlarmUpdate:(bool)arg1;
- (void)setNeedsDefaultTimedAlarmUpdate:(bool)arg1;
