...
- (void)vcMediaStream:(id <VCMediaStreamProtocol>)arg1 didReceiveFirstFrameWithTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;
...
- (void)vcMediaStream:(id <VCMediaStreamProtocol>)arg1 remoteMediaStalled:(bool)arg2 duration:(double)arg3;
