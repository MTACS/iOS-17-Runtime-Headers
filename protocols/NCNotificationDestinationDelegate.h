...
- (void)destination:(id <NCNotificationDestination>)arg1 setAllowsDirectMessages:(bool)arg2 forSectionIdentifier:(NSString *)arg3;
- (void)destination:(id <NCNotificationDestination>)arg1 setAllowsNotifications:(bool)arg2 forSectionIdentifier:(NSString *)arg3;
- (void)destination:(id <NCNotificationDestination>)arg1 setAllowsTimeSensitive:(bool)arg2 forSectionIdentifier:(NSString *)arg3;
- (void)destination:(id <NCNotificationDestination>)arg1 setDeliverQuietly:(bool)arg2 forSectionIdentifier:(NSString *)arg3;
- (void)destination:(id <NCNotificationDestination>)arg1 setMuted:(bool)arg2 untilDate:(NSDate *)arg3 forSectionIdentifier:(NSString *)arg4 threadIdentifier:(NSString *)arg5;
- (void)destination:(id <NCNotificationDestination>)arg1 setNotificationSystemSettings:(NCNotificationSystemSettings *)arg2;
- (void)destination:(id <NCNotificationDestination>)arg1 setScheduledDelivery:(bool)arg2 forSectionIdentifier:(NSString *)arg3;
- (void)destination:(id <NCNotificationDestination>)arg1 setSystemScheduledDeliveryEnabled:(bool)arg2 scheduledDeliveryTimes:(NSArray *)arg3;
