...
- (oneway void)observeMoveToURL:(NSURLPromisePair *)arg1 withSubitemURL:(NSURLPromisePair *)arg2 byWriterWithPurposeID:(NSString *)arg3 withFSID:(struct fsid { int x1[2]; })arg4 andFileID:(unsigned long long)arg5;
...
- (void)reacquireFromWritingClaimForID:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 6: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
- (void)relinquishToReadingClaimWithID:(void *)arg1 options:(void *)arg2 purposeID:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: NSString *, unsigned long long, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)relinquishToWritingClaimWithID:(void *)arg1 options:(void *)arg2 purposeID:(void *)arg3 subitemURL:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: NSString *, unsigned long long, NSString *, NSURLPromisePair *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
