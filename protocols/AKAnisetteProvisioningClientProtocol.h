...
- (void)fetchPeerAttestationDataForContext:(void *)arg1 withRequest:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: AKAppleIDAuthenticationContext *, NSURLRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, AKAttestationData *, NSError *, void*
