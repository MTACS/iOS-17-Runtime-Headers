...
- (void)setCommandEngagementFeedback:(_CPCommandEngagementFeedback *)arg1;
...
- (void)setDynamicButtonVisibilityFeedback:(_CPDynamicButtonVisibilityFeedback *)arg1;
...
- (void)setExperimentTriggeredFeedback:(_CPExperimentTriggeredFeedback *)arg1;
