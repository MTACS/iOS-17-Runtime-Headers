...
- (void)isEventCandidateForURL:(void *)arg1 andTitle:(void *)arg2 containsSchemaOrg:(void *)arg3 withCompletion:(void *)arg4; // needs 4 arg types, found 9: NSURL *, NSString *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SGXPCResponse1 *, void*
