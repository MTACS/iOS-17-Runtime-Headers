...
- (void)watchItemWithFileObjectID:(void *)arg1 options:(void *)arg2 gatherReply:(void *)arg3; // needs 3 arg types, found 8: BRFileObjectID *, unsigned short, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
