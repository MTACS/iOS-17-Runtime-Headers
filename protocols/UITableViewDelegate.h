...
- (bool)tableView:(UITableView *)arg1 canPerformPrimaryActionForRowAtIndexPath:(NSIndexPath *)arg2;
...
- (bool)tableView:(UITableView *)arg1 selectionFollowsFocusForRowAtIndexPath:(NSIndexPath *)arg2;
